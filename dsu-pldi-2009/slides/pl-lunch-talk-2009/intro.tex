...
{
\setbeamercovered{invisible}
\begin{frame}{Downtime}%{A Sub-title is optional}
\begin{itemize}
...
\item Less critical applications like Twitter, Youtube
\uncover<3->{
...
\begin{frame}{DSU Opportunities for managed languages}%{A Sub-title is optional}
